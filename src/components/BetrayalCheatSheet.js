        ...
        return (
            <div id='betrayal-cheatSheet'>
                ...
                <section id='footer'>
                    ...
                    <p className="source-code"><a href={'https://github.com/poetools/BetrayalCheatSheet'}>Source Code</a></p>
                </section>
            </div>
        );
    }
        ...
        return (
            <table id='syndicate-table' onClick={this.props.onClick}>
                ...
                <tr>
                    ...
                    <BetrayalTableCell img={'assets/encounters/leo/3research.png'} alt={'Research'} description={"Reforge colors/sockets/links 50 times"} id={'t312'} colourID={this.state.selected[TABLE_COL_SIZE*3 + 12]}/>
